...
namespace FullSerializer
{
	public struct fsResult
	{
		...
		public bool HasWarnings
		{
			get
			{
				return this._messages != null && Enumerable.Any<string>(this._messages);
			}
		}
		...
		{
			if (this.Failed || Enumerable.Any<string>(this.RawMessages))
			{
				throw this.AsException;
			}
			return this;
		...
		public string FormattedMessages
		{
			get
			{
				return string.Join(",\n", Enumerable.ToArray<string>(this.RawMessages));
			}
		}
